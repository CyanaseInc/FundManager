            ...
            <div className="bottom-container">
                <div className="bottom-container__left">
                    ...
                    <div className="box total-box">
                        <div className="total-box__left">
                            <div className="header-container">
                                <h3 className="section-header">Total Investment classes</h3>
                                                              
                            </div>
                            <h1 className="price">5<span className="price-currency">Clases</span></h1>
                    ...
                    <div className="box transaction-box">
                        <div className="header-container">
                            <h3 className="section-header">Available Clases</h3>
